                    ...
                    if (update.connection === 'close') {
                        ...
                        if (code !== DisconnectReason.loggedOut) {
                            ...
                            setTimeout(() => {
                                ...
                                // The user will need to press start again if this fails heavily, but let's try calling the start event internally.
                                // In a full implementation, you'd recursively call the connection function.
                            }, 3000);
                        } else {
